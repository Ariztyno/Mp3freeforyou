...
public class TimKiemCasiAdapter extends RecyclerView.Adapter<TimKiemCasiAdapter.ViewHolder> {
    ...
    public TimKiemCasiAdapter(Context context, ArrayList<Casi> mangcasi) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private ImageView imgCasi,Casilikebtn,imgExplore;
