...
public class UserplaylistDanhsachbaihatAdapter extends RecyclerView.Adapter<UserplaylistDanhsachbaihatAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageView imgluotthich,imgAddsongtoplaylist,imgDelsongfromplaylist,btndownload,imgExplore;
        public  ViewHolder(final View itemview){
            ...
            btndownload=itemview.findViewById(R.id.imgDownloadBtnRowDSBaihat);*/
            ...
            imgExplore.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(PreferenceUtils.getUsername(context)!=null){
                        ...
                        btnDeleteFromPlaylist.setVisibility(View.VISIBLE);
                        btnDeleteFromPlaylist.setClickable(true);
                        ...
                        delay_hanler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                //sự kiện xóa bài khỏi playlist
                                btnDeleteFromPlaylist.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Dataservice dataservice=APIService.getService();
