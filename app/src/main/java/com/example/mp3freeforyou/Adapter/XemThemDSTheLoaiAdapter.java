...
public class XemThemDSTheLoaiAdapter extends RecyclerView.Adapter<XemThemDSTheLoaiAdapter.ViewHolder> {
    Context context;
    ArrayList<Theloaibaihat> mangtheloai;

    public XemThemDSTheLoaiAdapter(Context context, ArrayList<Theloaibaihat> mangtheloai) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.row_xemthemdstheloai,parent,false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemview){
            super(itemview);
            imghinhplaylist=itemview.findViewById(R.id.imgRowXTDSTheloai);
            txtTenPlaylist=itemview.findViewById(R.id.txtRowTenPlaylistXTDSTheloai);
